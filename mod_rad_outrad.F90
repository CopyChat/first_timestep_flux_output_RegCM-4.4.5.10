...
! to save myvar, ctang
!   to_save_var_swuflx_ctang_2015_11_16
!attention: the call for rrtmg_sw is defined in Main/radlib/mod_rrtmg_drier.F90, !ctang
!which is depend on the czen, one element of czen > zero, the rrtmg_sw is called.  !ctang
    if ( irrtm == 1 ) then
      do k = 1 , ktf
        n = 1
        do i = ici1 , ici2
